...
import com.junbean.movieapp.ui.util.getAnnotatedText
...
fun ColumnScope.StartRatingBar(score: Float) {
    Card(
        ...
        Box(contentAlignment = Alignment.Center) {
            ...
            val starBackgroundColor = MaterialTheme.myColors.onPrimaryAlt.copy(
                alpha = 0.2f
            ).toArgb()
            val ratingBackgroundColor = MaterialTheme.myColors.onPrimaryAlt.copy(
                alpha = 0.05f
            ).toArgb()
